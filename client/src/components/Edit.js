...
function Edit(props) {
  ...
  return (
    <div className="col--2">
      {redirect ? <Redirect to={`/schedules/${props.type}/${slug}`} /> : ""}
      ...
      <main className="main">
        ...
        >
          {success ? "Schedule edited successfully" : "An error occured"}
        </div>
        <h1>Edit {props.type}</h1>
        {isLoading || !data ? (
          <h1>Results loading...</h1>
        ) : (
          <div>
            {props.type === "thursday" ? (
              <form id="thursdayForm" onSubmit={editThursday}>
                <div className="create">
                  ...
                  <div className="section treasures">
                  ...
                  <div className="row schedule__row grid">
                    ...
                    <div className="schedule__title">
                      ...
                      >
                        ...
                        <option value="Lockdown Ministry">
                          Lockdown Ministry
                        </option>
                      </select>
                    </div>
                  ...
                  <div className="row schedule__row grid">
                    ...
                    <div className="schedule__bro-sis">
                      <input
                        ...
                        id="closingPrayer"
                        className="create__input"
                        defaultValue={doc.closingPrayer}
                      />
                    </div>
                  </div>
                </div>
              ...
              <form id="sundayForm" onSubmit={editSunday}>
                <div className="create">
                  <label htmlFor="event" className="create__label">
                    Event
                  </label>
                  ...
                  <div className="row schedule__row grid">
                    ...
                    <div className="schedule__bro-sis">
                      <input
                        ...
                        id="publicTalkBro"
                        className="create__input"
                        defaultValue={doc.publicTalkBro}
                      />
                    </div>
                  </div>
